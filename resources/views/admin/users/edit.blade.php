...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-sm-9">
            ...
            {!! Form::model($user,['method'=>'PATCH', 'action'=>['AdminUsersController@update', $user] ,'files'=>true]) !!}
            {{csrf_field()}}

            <div class="'form-group">

                {!! Form::label('testing', 'TestInput:') !!}
                {!! Form::text('role',$user->role->name, ['class'=>'form-control'])!!}
                {{csrf_field()}}
